...
from .widget import JSWidget, create_JSXGraph, create_mermaid, create_flowchart, OPTWidget, create_optmentor
...
def _jupyter_nbextension_paths():
    ...
    return [{
        'section': 'notebook',
        'src': 'nbextension',
        'dest': 'optmentorwidgets',
        'require': 'optmentorwidgets/extension'
    }]
